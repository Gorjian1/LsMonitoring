...
public sealed class NodeListItem : INotifyPropertyChanged
{
    ...
    public string CardBackground => IsSelected ? "#D8EFFB" : "#FFFFFF";
    public string CardBorder => IsSelected ? "#5EC5EF" : "#D9DEE5";
    ...
    public void UpdateFrom(ReadingBuffer buffer, string? model = null, NodeCalibration? calibration = null)
    {
        ...
        StatusColor = latest is null ? "#B0B4BB" :
                      IsStale ? "#B0B4BB" :
                      latest.Invalid ? "#DC2626" :
                      "#16A34A";
