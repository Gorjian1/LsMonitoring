...
## [ ] M2-1 — Оживить или убрать «мёртвые» настройки тревог 🟡
...
## [ ] M2-2 — Починить счётчик сообщений 🟡
...
## [ ] M3-5 — `TryParse` и валидация ввода 🟢
...
## [ ] M5-4 — Дебаунс/async сохранения на UI-потоке 🟢
